...
export class IconbarComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.likePost) {
      this.postLikeIcon.fill = 'red';
      this.postLikeIcon.outline = this.likeIcon.black;
    } else {
      this.postLikeIcon.fill = 'black';
      this.postLikeIcon.outline = this.likeIcon.white;
    }
  }

  clickLikePost(): void {
    this.likePost = !this.likePost;
    this.clickPostEvent.emit(this.likePost);
